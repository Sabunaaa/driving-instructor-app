...
const InstructorCTA = () => {
  return (
    <div className="py-24 px-6 bg-[#0F172A] relative transform-gpu will-change-[transform]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-1 lg:order-2">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Join our community of professional driving instructors and start growing your business today. It takes less than 5 minutes to get started.
            </p>

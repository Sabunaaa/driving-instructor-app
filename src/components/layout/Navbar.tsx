...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white text-base">
      <div
        className="flex justify-between items-center px-8 py-2.5"
      ...
      >
        ...
        <Link
          ...
          className="flex items-center gap-2 h-14 cursor-pointer"
        >
        ...
        <div className="flex items-center">
          ...
          <div
            className="flex items-center px-4.5 py-2 cursor-pointer"

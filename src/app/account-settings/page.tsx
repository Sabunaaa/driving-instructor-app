                ...
                <>
                  ...
                  <div className="space-y-6">
                    ...
                    >
                      ...
                      the 14 days are up, sign in with your email and password,
                      and we'll send a link to reactivate account.
                    </p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p
                        ...
                        style={{ fontFamily: "Inter", fontWeight: 400 }}
                      >
                        Rentals we think you'll like. These recommendations may
                        be slightly outside your search criteria
                      </p>
                    </div>
                    <div className="flex items-center justify-center gap-14">
                      <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div style={{ marginTop: "5px" }}>
                          <ToggleSwitch
                            ...
                            onChange={() =>
                              handleNotificationToggle("featuredNews", "email")
                            }
                          />
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <div style={{ marginTop: "5px" }}>
                          <ToggleSwitch
                            ...
                            onChange={() =>
                              handleNotificationToggle("featuredNews", "phone")
                            }
                          />
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div style={{ marginTop: "5px" }}>
                          <ToggleSwitch
                            ...
                            onChange={() =>
                              handleNotificationToggle("finderExtras", "email")
                            }
                          />
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <div style={{ marginTop: "5px" }}>
                          <ToggleSwitch
                            ...
                            onChange={() =>
                              handleNotificationToggle("finderExtras", "phone")
                            }
                          />
                        </div>
                      </div>

...
import { Camera, User, Lock, Bell, Shield, ChevronRight } from "lucide-react";
...
const InputField = ({ label, ...props }: any) => (
  <div className="space-y-1.5">
    ...
    <input
      className="w-full px-4 py-2.5 bg-gray-50 border-transparent focus:bg-white focus:ring-2 focus:ring-[#F03D3D]/20 focus:border-[#F03D3D] rounded-xl transition-all outline-none text-sm"
      {...props}
    />
  </div>
);

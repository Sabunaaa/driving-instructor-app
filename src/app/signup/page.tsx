      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          ...
          <form className="space-y-4" onSubmit={async (e) => {
            ...
            const success = await signup(formData.fullName, formData.email, formData.password, userType as "student" | "instructor");
            if (success) {
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="flex flex-col items-center gap-1">
                    <User size={20} className={userType === 'student' ? 'text-red-500' : 'text-gray-400'} />
                    <span className="text-sm font-medium">Student</span>
                    <span className="text-xs text-gray-500">Learning to drive</span>
                  </div>
                </button>
                <button
                  type="button"
                ...
                >
                  <div className="flex flex-col items-center gap-1">
                    <CarFront size={20} className={userType === 'instructor' ? 'text-red-500' : 'text-gray-400'} />
                    <span className="text-sm font-medium">Instructor</span>
                    <span className="text-xs text-gray-500">Teaching to drive</span>
                  </div>
                </button>
              </div>
            </div>
          ...
          <p className="mt-4 text-center text-sm text-gray-600">
            ...
            <a href="/login" className="font-medium text-red-500 hover:text-red-600 transition-colors">
              Sign in
            </a>
          </p>
        </div>

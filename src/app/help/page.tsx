...
//@ts-ignore
import { Search, Book, MessageCircle, Phone, Mail, ChevronRight, HelpCircle, Users, Car, Calendar, CreditCard, Shield } from 'lucide-react';
  ...
  const helpCategories = [
    {
      ...
      articles: ['Setting up your profile', 'How to book lessons', 'Payment methods']
    },
    {
      icon: Car,
      title: 'For Instructors',
      description: 'Resources for driving instructors',
      articles: ['Managing students', 'Setting availability', 'Vehicle requirements']
    },
    {
      icon: Calendar,
            ...
            <div className="space-y-8">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="space-y-1">
                              {category.articles.map((article, articleIndex) => (
                                <div key={articleIndex} className="flex items-center gap-2 text-sm text-gray-500 hover:text-red-600 cursor-pointer">
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <ul className="space-y-2 text-sm text-blue-800">
                  ...
                  <li>• Keep your profile information up to date for better matches</li>
                  <li>• Cancel lessons at least 24 hours in advance to avoid fees</li>
                  <li>• Rate your instructor after each lesson to help others</li>
                </ul>
              </div>
            </div>
          </main>
